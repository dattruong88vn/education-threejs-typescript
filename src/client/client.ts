...
function regenerateBoxGeometry() {
  ...
  cube.geometry.dispose(); // clear old geometry in contructor method
  cube.geometry = newGeometry; // add new geometry
}
...
spherePropertiesFolder
  .add(sphereData, "widthSegments", 1, 32, 1)
  .onChange(regenerateSphereGeometry);
spherePropertiesFolder
  .add(sphereData, "heightSegments", 1, 16, 1)
  .onChange(regenerateSphereGeometry);
spherePropertiesFolder
